...
$\sigma_{\mathrm{cal}}$-aware ranking (overall MAE 2.66\,eV,
$5.5\times$ the in-distribution 0.486\,eV). The two bounds are
qualitatively consistent: \modelname's IMP2D test-fold MAE
underestimates the true deployment ceiling by a factor of
$\sim 5\times$ on the chemistry distributions of practical
interest. We make this ceiling an explicit limitation
(Sec.~\ref{sec:discuss}) rather than a hidden one.
