...
% Inserted into main.tex after \input{sec_prospective_dft}.
% =====================================================================
...
evaluate the same 4-seed ensemble (identical checkpoints, identical
...
$1.55$\,eV (CI $1.20$--$1.90$), inside the $1.4$--$2.1$\,eV LOHO
band. Operationally this reproduces the deployment recipe of
...
($r=0.27$). For screening purposes, an uncertainty that degrades
