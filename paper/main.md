...
- **OOD 一致性 (``scripts/loho_interp_check.py``)**：
  ...
  | 量 | 域内 | LOHO MoS2 | LOHO Cr2I6 | LOHO C2H2 |
  |---|---|---|---|---|
  | OOD 退化倍数 (Test MAE / 0.516) | 1.00 (基线) | 1.00× | 1.63× | **4.65×** |
  | mean attn → defect | 0.522 | 0.611 | 0.499 | **0.931** |
  | mean attn → random other | 0.016 | 0.011 | 0.020 | 0.001 |
  | attn 比例 | 32× | 53× | 26× | **685×** |
  | defect 占总归因 | 90.7% | 90.3% | 91.0% | **78.9%** |
  | mean \|Δ\| at defect | 6.87 | 6.13 | 7.14 | **1.95** eV |
