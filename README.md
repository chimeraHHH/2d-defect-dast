...
| V2 EMA vs V2 | +0.014 | [−0.008, +0.034] | 0.202 | 不显著（V2 种子范围内） |
| V10 Combo vs V2 | +0.011 | [−0.011, +0.032] | 0.313 | 不显著（val 最优 0.377） |
| V9 Contrast vs V2 | +0.029 | [+0.007, +0.052] | **0.009** | **显著更差** ★ |
| V12 LDS+Phys vs V2 | +0.032 | [+0.009, +0.055] | **0.006** | **显著更差** ★ |
| V2 Focal vs V2 | +0.038 | [+0.014, +0.062] | **0.001** | **显著更差** ★★ |
| V11 LDS vs V2 | +0.052 | [+0.026, +0.076] | **<0.001** | **显著更差** ★★ |
| V13 RnC vs V2 | +0.061 | [+0.037, +0.085] | **<0.001** | **显著更差** ★★ |
| V2 Uncertainty vs V2 | +0.085 | [+0.044, +0.128] | **<0.001** | **显著更差** ★★★ |
...
| **V12 LDS+物理+全条件化** | V6+V3+V9+LDS+EMA 协同 | +17K | ❌ 0.413 | 综合方案（LDS 拖累） |
| **V10 最优组合** | V6+V3+V9+V14+EMA 协同 | +31K | ✅ 0.392 | 综合方案（val 0.377 最优，test gap） |
...
| CT-V2+AllCombo (V10) | 0.86 M | 0.392 | −27% |
| CT-V2+LDS+Phys (V12) | 0.85 M | 0.413 | −24% |
...
| V10 BestCombo (全创新组合) | 0.86 M | 0.392 eV | 1.031 eV | val 0.377 最优但 test gap 0.015 |
| V12 LDS+Physics (全物理组合) | 0.85 M | 0.413 eV | 0.985 eV | LDS 拖累，[0,2) 退化 |
...
- [x] ~~V9 缺陷-宿主对比条件化~~（0.410 eV，显著更差 p=0.009，[7,25) 退化严重）
- [x] ~~V11 LDS 标签分布平滑~~（0.433 eV，显著更差 p<0.001，[0,2) 退化灾难性）
- [x] ~~V13 RnC 对比+LDS~~（0.442 eV，显著更差 p<0.001，辅助对比损失干扰主回归）
- [x] ~~V2 Focal MAE~~（0.419 eV，显著更差 p=0.001，上权困难样本损害常见范围精度）
- [x] ~~V2 异方差不确定性~~（0.466 eV，显著更差 p<0.001，[7,25) 灾难性 ΔMAE=+0.695）
- [x] ~~V12 LDS+物理+全条件化~~（0.413 eV，显著更差 p=0.006，LDS 组件主导退化）
