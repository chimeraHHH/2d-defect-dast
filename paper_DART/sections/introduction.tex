...
assessment.
%
Our central thesis is that, in the data-limited regime characteristic of
materials science ($N \sim 10^4$), \emph{physically informed architecture
design combined with systematic data and training engineering} yields
larger gains than scaling model capacity alone.
\dart{} demonstrates this by outperforming models with $5\times$ more
parameters through targeted inductive biases---defect-site awareness and
long-range periodic attention---rather than brute-force parameterization.
%
