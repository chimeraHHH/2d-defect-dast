...
def main():
    ...
    samples = []
    found_formulas = set()
    for row in db.select(limit=1000):
        if row.formula in tested_formulas or row.formula in found_formulas:
            continue
