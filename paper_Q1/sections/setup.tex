...
Because only five paired repeats were prespecified, the intervals are
...
host--impurity pairs for pair-held-out and compositional-block evaluation.
Within each resampled chemical unit all associated structures remain together.
Screening intervals use 20,000 host--impurity-pair cluster-bootstrap
...
study.  Predictive and screening claims rely exclusively on the canonical
IMP2D targets; an independently generated, target-matched external test set is
