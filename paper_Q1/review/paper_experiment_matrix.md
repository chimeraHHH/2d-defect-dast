...
| E7 | Generate fail-closed manuscript tables, figures, and macros | Pending E5 | `scripts/prm_make_result_assets.py` | Releases all numerical Results, Discussion, and Conclusion text |
